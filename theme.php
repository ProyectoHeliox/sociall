...
/*
 * Name: Sociall
 * Description: Sociall family (light, dark): Sleek and Functional Themes 
 * Version: 1.2.1
...
function sociall_init(&$a) {
    ...
    */
	if (($a->argv[0] . $a->argv[1]) === ("profile" . $a->user['nickname'])) {
		sociall_community_info();
	}

	$a->page['htmlhead'] .= <<<EOT
	<script type="text/javascript" src="$baseurl/view/theme/sociall/js/modernizr.custom.2.5.3.min.js"></script>
...
function sociall_community_info() {
